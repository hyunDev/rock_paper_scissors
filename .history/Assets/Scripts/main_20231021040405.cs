...
public class main : MonoBehaviour
{
    ...
    public void setComImage1() {
        objCom.GetComponent<Image>().sprite = Resources.Load<Sprite>("Image_1") as Sprite;
    }
    public void setComImage2() {
        objCom.GetComponent<Image>().sprite = Resources.Load<Sprite>("Image_2") as Sprite;
    }
    public void setComImage3() {
        objCom.GetComponent<Image>().sprite = Resources.Load<Sprite>("Image_3") as Sprite;
    }
