...
public class main : MonoBehaviour
{
    ...
    public void setComImage1() {
        objComImage.GetComponent<Image>().sprite = Resources.Load<Sprite>("Image_1") as Sprite;
    }
    public void setComImage2() {
        objComImage.GetComponent<Image>().sprite = Resources.Load<Sprite>("Image_2") as Sprite;
    }
    public void setComImage3() {
        objComImage.GetComponent<Image>().sprite = Resources.Load<Sprite>("Image_3") as Sprite;
    }
    IEnumurator startComImageAnim(int choice) {
        ...
        while(true) {
            yield return null;
            if (changeSpeed <= 0.01f ) {
                break;
            }
            changeSpeed = Mathf.Lerp(changeSpeed, 0, Time.deltaTime * 2f);
            int order = curOrder % 3 + 1;
            string fnName = "setComImage" + order.ToString();
            Invoke(fnName, 100f - changeSpeed);
        }
        setComImage(choice);
    }
